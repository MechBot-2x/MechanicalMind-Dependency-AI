...
class CompatibilityMatrix:
    def __init__(self, db_path: str = None):
        self.db_path = db_path or str(Path(__file__).parent / 'knowledge_base' / 'version_compatibility.db')
        self._init_db()
    ...
    def add_compatibility_record(self, package: str, version: str, 
                               python_version: str, status: str) -> bool:
    ...
    def check_compatibility(self, package: str, version: str, 
